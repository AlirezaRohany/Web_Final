...
namespace web_final
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DarmanKadehContext>(options =>
            {
                options.UseSqlite(Configuration.GetConnectionString("DarmanKadehContext"));
                options.LogTo(Console.WriteLine);
            });
            
            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<DarmanKadehContext>()
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "web_final", Version = "v1" });
            });
        }
